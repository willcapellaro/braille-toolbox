...
export { checkForNestedPattern, getFillInstructionData } from './graphics/shared/svg/utils/fillOperations.mjs';
export { appendSVGPath, calculatePathArea, extractSubpaths } from './graphics/shared/svg/utils/pathOperations.mjs';
