...
export { PassthroughFilter } from './defaults/passthrough/PassthroughFilter.mjs';
...
export { default as passthroughFrag } from './defaults/passthrough/passthrough.frag.mjs';
export { default as passthroughWgsl } from './defaults/passthrough/passthrough.wgsl.mjs';
