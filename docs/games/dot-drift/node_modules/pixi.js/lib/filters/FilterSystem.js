...
var PassthroughFilter = require('./defaults/passthrough/PassthroughFilter.js');
...
class FilterSystem {
  ...
  _getPassthroughFilter() {
    this._passthroughFilter ?? (this._passthroughFilter = new PassthroughFilter.PassthroughFilter());
