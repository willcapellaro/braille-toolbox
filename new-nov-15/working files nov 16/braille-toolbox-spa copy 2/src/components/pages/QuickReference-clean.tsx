      ...
      <Box sx={{ py: 4 }}>
        ...
        <Box sx={{ textAlign: 'center', mb: 4 }}>
          ...
          <Typography variant="body1" sx={{ maxWidth: 600, mx: 'auto', mb: 4 }}>
            Your comprehensive braille learning companion with interactive visual references from your original educational content.
          </Typography>
        ...
        <Paper elevation={1} sx={{ p: 3, mb: 4 }}>
          <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 2 }}>
            <Tabs value={activeTab} onChange={handleTabChange} aria-label="braille character categories">
              <Tab label={`Letters (${letters.length})`} />
              <Tab label={`Numbers (${numbers.length})`} />
          ...
          {slateMode && (
            <Box sx={{ mt: 2, p: 2, backgroundColor: 'info.light', borderRadius: 1 }}>
              <Typography variant="body2">
                📝 <strong>Slate Mode:</strong> Characters are flipped horizontally for slate & stylus writing (right-to-left).
              </Typography>
            </Box>
          )}
        </Paper>
        ...
        <Paper sx={{ p: 4, backgroundColor: 'grey.50' }}>
          ...
          <Grid container spacing={3}>
            <Grid item xs={12} md={4}>
              ...
              <Typography variant="body2">
                Letters a-j use only the top 4 dots. This pattern repeats for k-t (adding dot 3) and the remaining letters.
              </Typography>
            </Grid>
            <Grid item xs={12} md={4}>
              <Typography variant="subtitle2" color="primary" gutterBottom>
            ...
            <Grid item xs={12} md={4}>
              ...
              <Typography variant="body2">
                This displays your actual educational braille content from dot-decoder-content.json with your original SVG graphics.
              </Typography>
            </Grid>
          </Grid>
        </Paper>
